...
dummy_data_clean <- as.data.table(mapply(function(a,b) b(a), dummy_data_clean, lapply(funs, get), SIMPLIFY = F))
...
options(ggplot2.continuous.colour=cols_cont)
options(ggplot2.continuous.fill = cols_cont)
